	...
	const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
		[0] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD),	ENCODER_CCW_CW(KC_PGDN, KC_PGUP) }, // Home
		[1] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD),	ENCODER_CCW_CW(KC_PGDN, KC_PGUP) }, // Lower
		[2] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD),	ENCODER_CCW_CW(KC_PGDN, KC_PGUP) }, // Raise
		[3] = { ENCODER_CCW_CW(KC_MPRV, KC_MNXT),	ENCODER_CCW_CW(RGB_VAD, RGB_VAI) }, // Special
		[4] = { ENCODER_CCW_CW(KC_VOLU, KC_VOLD),	ENCODER_CCW_CW(KC_PGDN, KC_PGUP) }, // Special
	};
#endif